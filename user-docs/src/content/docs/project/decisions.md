...
What ssoossh *does* do is in [How it works](/ssoossh/concepts/). The
operator-facing summary of the security properties these decisions produce is
the [security model](/ssoossh/concepts/security-model/).
