...
| [`cert_options.pam.lifetime_policy.tiers[].name`](#lifetime_policytiersname) | string | `empty` |
| [`cert_options.pam.lifetime_policy.tiers[].when.group`](#lifetime_policytierswhengroup) | string | `empty` |
| [`cert_options.pam.lifetime_policy.tiers[].when.claim`](#lifetime_policytierswhenclaim) | string | `empty` |
| [`cert_options.pam.lifetime_policy.tiers[].when.at_least`](#lifetime_policytierswhenat_least) | number | `0` |
| [`cert_options.pam.lifetime_policy.tiers[].when.at_most`](#lifetime_policytierswhenat_most) | number | `0` |
| [`cert_options.pam.lifetime_policy.tiers[].when.exactly`](#lifetime_policytierswhenexactly) | number | `0` |
| [`cert_options.pam.lifetime_policy.tiers[].when.equals`](#lifetime_policytierswhenequals) | string | `empty` |
| [`cert_options.pam.lifetime_policy.tiers[].when.one_of`](#lifetime_policytierswhenone_of) | list | `empty` |
| [`cert_options.pam.lifetime_policy.tiers[].when.contains`](#lifetime_policytierswhencontains) | string | `empty` |
| [`cert_options.pam.lifetime_policy.tiers[].when.all_of`](#lifetime_policytierswhenall_of) | list | `empty` |
| [`cert_options.pam.lifetime_policy.tiers[].when.any_of`](#lifetime_policytierswhenany_of) | list | `empty` |
| [`cert_options.pam.lifetime_policy.tiers[].max_duration`](#lifetime_policytiersmax_duration) | duration | `0` |
| [`cert_options.pam.lifetime_policy.tiers[].grant_extensions`](#lifetime_policytiersgrant_extensions) | list | `empty` |
| [`cert_options.pam.lifetime_policy.tiers[].max_enrollment_duration`](#lifetime_policytiersmax_enrollment_duration) | duration | `0` |
| [`cert_options.pam.lifetime_policy.source_policy`](#lifetime_policysource_policy) | list | `empty` |
| [`cert_options.pam.lifetime_policy.source_policy[].cidr`](#lifetime_policysource_policycidr) | string | `empty` |
| [`cert_options.pam.lifetime_policy.source_policy[].max_duration`](#lifetime_policysource_policymax_duration) | duration | `0` |
| [`cert_options.pam.lifetime_policy.source_policy[].extensions`](#lifetime_policysource_policyextensions) | list | `empty` |
| [`cert_options.pam.lifetime_policy.source_policy[].removed_extensions`](#lifetime_policysource_policyremoved_extensions) | list | `empty` |
| [`cert_options.pam.lifetime_policy.source_policy[].pin_source_address`](#lifetime_policysource_policypin_source_address) | bool | `false` |
