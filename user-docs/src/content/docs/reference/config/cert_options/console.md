...
Configures issuance of console certificates: the certificate that authenticates an interactive console login on a machine with no browser in front of it, where the approval travels as a short code the human reads off the screen and types into the web UI (see https://mnestor.github.io/ssoossh/concepts/console-flow/).
