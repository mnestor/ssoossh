...
// minimally-privileged process later (see docs/signer-separtion.md) without
...
// than the config file — an ssh-agent connection (per root CLAUDE.md's "CA
...
// process (see docs/watermill-phase6-nats-deferred.md), only the signer gets
