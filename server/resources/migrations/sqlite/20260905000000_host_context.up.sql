...
ALTER TABLE certificate_requests ADD COLUMN caller_uid INTEGER;
ALTER TABLE certificate_requests ADD COLUMN caller_pid INTEGER;
ALTER TABLE certificate_requests ADD COLUMN caller_ppid INTEGER;
...
ALTER TABLE certificate_requests ADD COLUMN client_time DATETIME;
