...
generic and portable to other repos. See also `pam-safe-internal.md`,
...
- The top-level product/service packages `go.md`'s cross-package rule
  ...
  separate project (github.com/mnestor/ssoossh-pam) and cannot import
  `internal/` at all; see `pam-safe-internal.md` for the constraints it
  still places on the shared packages.
