...
[Architecture](https://mnestor.github.io/ssoossh/internals/architecture/) and works today, in one process, on
...
[Startup modes](https://mnestor.github.io/ssoossh/operations/startup-modes/). The
...
discussion in [Architecture](https://mnestor.github.io/ssoossh/internals/architecture/) becomes moot for
...
- [Architecture](https://mnestor.github.io/ssoossh/internals/architecture/) — what exists today.
