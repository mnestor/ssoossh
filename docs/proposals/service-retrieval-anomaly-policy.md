...
[flows.md](../flows.md) and the notification machinery in
[email-notifications.md](../email-notifications.md). Read the latter first: the
...
[email-notifications.md](../email-notifications.md#what-is-never-emailed)
