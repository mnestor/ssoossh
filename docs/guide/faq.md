...
check [decisions.md](../project/decisions.md) first; that document exists for
exactly those.
...
of `ssh_config` ([configuration.md](../operations/configuration.md#ssh_config)), and
...
agent. [configuration.md](../operations/configuration.md#ssh_config).
...
Details: [configuration.md](../operations/configuration.md#diagnostics--v-and---debug).
...
([decisions.md](../project/decisions.md#security-invariants)).
...
([configuration.md](../operations/configuration.md#sshd-on-target-hosts)). Optionally,
...
touching. [decisions.md](../project/decisions.md) covers why there is no revocation
machinery.
...
lockout warning in [deployment.md §8](../operations/deployment.md#8-pam-sudo-and-su)
...
[deployment.md §8](../operations/deployment.md#8-pam-sudo-and-su).
...
see [decisions.md](../project/decisions.md). That may change if a real
...
is [deployment.md §4](../operations/deployment.md#4-oidc-provider-setup-pocket-id).
...
Procedure: [deployment.md §7](../operations/deployment.md#7-running-more-than-one-instance);
settings: [configuration.md](../operations/configuration.md#multi-instance-and-startup-modes).
...
[deployment.md §6](../operations/deployment.md#6-startup-modes-full-api-and-sign) and
[signing-pipeline.md](../internals/signing-pipeline.md) for how the processes and NATS
fit together.
...
ignored). See [configuration.md](../operations/configuration.md#tls) and
[deployment.md §5](../operations/deployment.md#5-reverse-proxy-and-tls).

### SQLite or PostgreSQL?

SQLite for a single instance (the default; put the file in
`/var/lib/ssoossh/` under systemd). PostgreSQL is required for
multi-instance. [configuration.md](../operations/configuration.md#database).
...
[deployment.md §7](../operations/deployment.md#7-running-more-than-one-instance) and the
JetStream entry in [decisions.md](../project/decisions.md).
...
([decisions.md](../project/decisions.md), [features.md](features.md)).
...
derived from it. [configuration.md](../operations/configuration.md#tls).

### Every request shows the proxy's IP in the audit trail

`http.trusted_proxies` is unset, so `X-Forwarded-For` is ignored. Set it
to the proxy's CIDR. [deployment.md §5](../operations/deployment.md#5-reverse-proxy-and-tls).
